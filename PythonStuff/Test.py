...
def emnist_train(model):
    ...
    #model.save('emnist_letters_V1.h5')
...
if __name__ == "__main__":
    ...
    #model = emnist_model2()
    #emnist_train(model)
    #model.save('emnist_letters_V2.h5')

    model = keras.models.load_model('emnist_letters_V1.h5')
    s_out = img_to_str(model, "ImageReader-ImagePixelConvert\Images\canvasImg.png")
    print(s_out)
    f = open('result.txt','w')
    f.write(s_out)